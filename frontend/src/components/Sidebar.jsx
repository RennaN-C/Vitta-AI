...
import { 
  ...
  TrendingUp, Bell, History, User, LogOut 
} from "lucide-react";
...
const Sidebar = ({ usuario, telaAtiva, setTelaAtiva, onLogout }) => {
  const menus = [
    ...
    { id: "tendencias", label: "Tendências", icon: <TrendingUp size={20} /> },
  ...
  return (
    <aside className="w-64 bg-[#0d1117] border-r border-slate-800 flex flex-col h-screen p-6">
